...
//    var dayOfWeek:String? = null
    ...
    override fun toString(): String {
        return "CreatePreferenceForm(userId=$user_id, mondaySweep=$mondaySweep, mondayDishes=$mondayDishes, tuesdaySweep=$tuesdaySweep, tuesdayDishes=$tuesdayDishes, weekOverride=$weekOverride, weekNumber=$weekNumber, year=$year, chore=$chore)"
    }
}